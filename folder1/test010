# -*- coding: utf-8 -*-
"""
Created on Tue Oct 10 08:05:51 2023


"""

# Open File in Read Mode
file_1 = open('code_new.txt', 'r')
file_2 = open('code_new(1).txt', 'r')
...
with open('code_new.txt') as file1:
    with open('code_new(1).txt') as file2:
